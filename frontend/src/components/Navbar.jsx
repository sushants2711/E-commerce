        ...
        <>
            <nav className="bg-gray-200 shadow-inner shadow-red-900 border-b-2 border-red-200 " >
                <div className="max-w-full mx-auto px-4 md:px-4 lg:px-12 py-2 md:py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex-shrink-0">
                            <a href="#" className="text-3xl md:text-2xl lg:text-3xl font-bold font-serif hover:text-red-400">
                                goldBasket
                            </a>
                        </div>
                        ...
                        <div className="hidden md:flex space-x-14">
                            ...
                            <Link to="/logout" className="text-xl text-gray-800 hover:text-black font-serif" onClick={handleLogout}>
                                Logout
                            </Link>
                        </div>
                ...
                <div className={`md:hidden ${isMobileMenuOpen ? "block" : "hidden"} py-2 text-center`}>
                    ...
                    <Link to="/logout"
                        className="block px-4 py-2 text-gray-800 hover:bg-gray-300 hover:text-blue-600" onClick={handleLogout}
                    >
                        Logout
                    </Link>
                </div>
